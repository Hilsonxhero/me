    ...
    <div>
        <section class="container">
            <div class="row">
                    ...
                    <div class="position-sticky top-0">
                        <div class="text-center pt-5">
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="bx bx-bell fs-xl opacity-60 me-2"
                                    ></i>
                                    Notifications
                                </a>
                                <a
                                ...
                                >
                                    <i
                                        class="bx bx-bookmark fs-xl opacity-60 me-2"
                                    ></i>
                                    Saved Items
                                </a>
                                <a
                ...
                <!-- Account security -->
                <div
                    class="col-md-8 offset-lg-1 pb-5 mb-lg-2 mb-lg-4 pt-md-5 mt-n3 mt-md-0"
                >
                    <div class="ps-md-3 ps-lg-0 mt-md-2 pt-md-4 pb-md-2">
                        ...
                        <p class="pb-3 mb-3">
                            ...
                            account. Remove any sessions that you do not
                            recognize.
                        </p>
                        <ul class="list-unstyled mb-0">
                            ...
                            >
                                <div class="d-flex align-items-start me-3">
                                    <div class="bg-secondary rounded-1 p-2">
                                        <i
                                            class="bx bx-desktop fs-xl text-primary d-block"
                                        ></i>
                                    </div>
                                    <div class="ps-3">
                                ...
                                >
                                    <i
                                        class="bx bx-x fs-xl ms-sm-n1 me-sm-1"
                                    ></i>
                            ...
                            >
                                <div class="d-flex align-items-start me-3">
                                    <div class="bg-secondary rounded-1 p-2">
                                        <i
                                            class="bx bx-mobile fs-xl text-primary d-block"
                                        ></i>
                                    </div>
                                    <div class="ps-3">
                                        <div class="fw-medium text-nav mb-1">
                                        ...
                                        >
                                        <span
                                            class="d-inline-block fs-sm text-muted"
                                            >20 hours ago</span
                                        >
                                    </div>
                                </div>
