<template>
    <div class="col-md-8 offset-lg-1 pb-5 mb-2 mb-lg-4 pt-md-5 mt-n3 mt-md-0">
        <div class="ps-md-3 ps-lg-0 mt-md-2 py-md-4">
            <h1 class="h2 pt-xl-1 pb-3">update educational experiences</h1>
...
const updateHandler = () => {
    ...
    axios
        .put(`/api/admin/experiences/educational/${id.value}`, data)
        .then(({ data }) => {
...
onMounted(() => {
    ...
    axios
        .get(`/api/admin/experiences/educational/${id.value}`)
        .then(({ data }) => {
