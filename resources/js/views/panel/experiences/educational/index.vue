<template>
    <div class="col-md-8 offset-lg-1 pb-5 mb-2 mb-lg-4 pt-md-5 mt-n3 mt-md-0">
        <div class="ps-md-3 ps-lg-0 mt-md-2 pt-md-4 pb-md-2">
            ...
            >
                <h1 class="fs-sm mb-2">educational experiences</h1>

                <router-link
                    class="btn btn-outline-primary ps-4"
                    :to="{ name: 'panel admin experiences educational create' }"
                >
...
const deleteHandler = (id, index) => {
    axios
        .delete(`/api/admin/experiences/educational/${id}`)
        .then(({ data }) => {
...
onMounted(() => {
    axios
        .get("/api/admin/experiences/educational")
        .then(({ data }) => {
